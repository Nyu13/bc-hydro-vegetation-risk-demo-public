...
BC_TRANSMISSION_BUNDLED_GEOJSON = DEMO_DATA_DIR / "bc_transmission_lines.geojson"
...
SURREY_CORRIDOR_SEGMENTS_BUNDLED_GEOJSON = DEMO_DATA_DIR / "surrey_corridor_segments.geojson"
SURREY_CORRIDOR_BUFFER_BUNDLED_GEOJSON = DEMO_DATA_DIR / "surrey_corridor_buffer_200m.geojson"
SURREY_CORRIDOR_SEGMENTS_CANDIDATES: tuple[Path, ...] = (
    SURREY_CORRIDOR_SEGMENTS_GEOJSON,
    SURREY_CORRIDOR_SEGMENTS_BUNDLED_GEOJSON,
)
SURREY_CORRIDOR_BUFFER_CANDIDATES: tuple[Path, ...] = (
    SURREY_CORRIDOR_BUFFER_GEOJSON,
    SURREY_CORRIDOR_BUFFER_BUNDLED_GEOJSON,
)
...
OKANAGAN_CORRIDOR_SEGMENTS_BUNDLED_GEOJSON = DEMO_DATA_DIR / "okanagan_corridor_segments.geojson"
OKANAGAN_CORRIDOR_BUFFER_BUNDLED_GEOJSON = DEMO_DATA_DIR / "okanagan_corridor_buffer_200m.geojson"
OKANAGAN_CORRIDOR_SEGMENTS_CANDIDATES: tuple[Path, ...] = (
    OKANAGAN_CORRIDOR_SEGMENTS_GEOJSON,
    OKANAGAN_CORRIDOR_SEGMENTS_BUNDLED_GEOJSON,
)
OKANAGAN_CORRIDOR_BUFFER_CANDIDATES: tuple[Path, ...] = (
    OKANAGAN_CORRIDOR_BUFFER_GEOJSON,
    OKANAGAN_CORRIDOR_BUFFER_BUNDLED_GEOJSON,
)
